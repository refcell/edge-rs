...
const NULLARY_INSTS: &[&str] = &[
    "IPush0",
    "IAdd", "IMul", "ISub", "IDiv", "ISDiv", "IMod", "ISMod",
    "IExp", "IAddMod", "IMulMod", "ISignExtend",
    "ILt", "IGt", "ISLt", "ISGt", "IEq", "IIsZero",
    "IAnd", "IOr", "IXor", "INot", "IByte", "IShl", "IShr", "ISar",
    "IKeccak256",
    "IAddress", "IBalance", "IOrigin", "ICaller", "ICallValue",
    "ICallDataLoad", "ICallDataSize", "ICodeSize", "IGasPrice",
    "IReturnDataSize", "IExtCodeSize", "IExtCodeHash",
    "IBlockHash", "ICoinbase", "ITimestamp", "INumber",
    "IPrevrandao", "IGasLimit", "IChainId", "ISelfBalance", "IBaseFee",
    "IPop", "IMLoad", "IMStore", "IMStore8", "ISLoad", "ISStore",
    "ITLoad", "ITStore", "IMCopy",
    "ICreate", "ICall", "ICallCode", "IReturn", "IDelegateCall",
    "ICreate2", "IStaticCall", "IRevert", "IInvalid", "ISelfDestruct",
    "IGas", "IPc", "IMSize", "IStop",
];
