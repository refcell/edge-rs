...
fn test_ownable_compiles() {
    let bc = compile_contract("std/access/ownable.edge");
...
fn test_auth_compiles() {
    let bc = compile_contract("std/auth.edge");
...
fn test_safe_transfer_compiles() {
    let bc = compile_contract("std/tokens/safe_transfer.edge");
...
fn test_reentrancy_guard_compiles() {
    let bc = compile_contract("std/patterns/reentrancy_guard.edge");
    assert!(
        !bc.is_empty(),
...
fn test_merkle_compiles() {
    let bc = compile_contract("std/utils/merkle.edge");
